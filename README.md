...
<img src="./SensorNode/PCB_Layout/Air_Quality_Analyzer_PCB_Layout.png" alt="PCB Layout" width="500"/>
...
### Ο χρήστης θα πρέπει: 
* Πρώτα, αφού βρεθεί στις γραμμές **31** και **37** του αρχείου ***start_measurements.py***, να ακολουθήσει τις οδηγίες για την εγκατάσταση των δύο αυτών βιβλιοθηκών από το **Raspberry**
* Μετά, να ανοίξει την κονσόλα του **Raspberry**
* Ύστερα να κατευθυνθεί στη διεύθυνση που βρίσκεται το αρχείο ***start_measurements.py***
* Κατόπιν θα πρέπει να γράψει: `sudo python start_measurements.py`
